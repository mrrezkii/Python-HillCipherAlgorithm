...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2020 at 04:11 AM
...
--
ALTER TABLE `dekripsi`
  MODIFY `id_dekripsi` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `enkripsi`
--
ALTER TABLE `enkripsi`
  MODIFY `id_enkripsi` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
